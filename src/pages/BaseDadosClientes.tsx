...
export default function BaseDadosClientes() {
  ...
  return (
    <div className="base-vendas-page">
      <header className="base-vendas-header">
        ...
        <p className="base-vendas-subtitle">Visualize e pesquise todos os clientes cadastrados</p>
      </header>
